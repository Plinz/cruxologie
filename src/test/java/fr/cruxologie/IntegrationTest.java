...
import fr.cruxologie.CruxologieApp;
import fr.cruxologie.config.AsyncSyncConfiguration;
import fr.cruxologie.config.EmbeddedSQL;
...
@SpringBootTest(classes = { CruxologieApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
